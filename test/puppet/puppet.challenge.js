...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        const depRequiredBefore = await this.lendingPool.calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE)
        console.log("Before swap deposit required: " + ethers.utils.formatEther(depRequiredBefore))

        // Attack pattern: make ETH balance zero in uniswap exchange
        ...
        console.log("After swap deposit required: " + ethers.utils.formatEther(depRequired))
